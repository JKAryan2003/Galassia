...
const Login = () => {
  ...
  return (
    <form onSubmit={() => onSubmitHandler()} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
      ...
      {currentState === 'Log In' ? '' : <input type="text" className='w-full px-3 py-2 border border-gray-800' required placeholder='Name' /> }
      ...
      <button className='bg-black text-white px-8 py-2 mt-4'>{currentState === 'Log In' ? 'Sign In' : 'Sign Up'}</button>
    </form>
)
}
